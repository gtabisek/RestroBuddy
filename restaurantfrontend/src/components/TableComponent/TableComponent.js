 ...
 * TableComponent.js
 *
 * Displays available tables and floors for booking and order management.
 * Fetches floor and table data from backend and integrates with Redux for order state.
 * Allows admin to select floor/table and view order totals for each table.
 */
