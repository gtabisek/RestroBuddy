 ...
 * AllSales.js
 *
 * Displays all sales records for the restaurant with filtering by date range.
 * Fetches and displays bills, total sales amount, and allows date selection.
 * Uses MaterialTable for tabular data and MUI for UI components.
 */
