 ...
 * tablebooking.js
 *
 * This route handles table booking management for restaurants.
 * Main endpoints:
 *   POST /tablebooking/table_submit - Adds a new table for a restaurant.
 *   POST /tablebooking/fetch_all_floor - Fetches all floors for a restaurant.
 *   POST /tablebooking/fetch_all_table_by_floor - Fetches all tables for a given floor.
 *   POST /tablebooking/fetch_all_table - Fetches all tables for a restaurant.
 *
 * Dependencies:
...
/**
 * POST /tablebooking/table_submit
 * Adds a new table for a restaurant.
 */
...
/**
 * POST /tablebooking/fetch_all_floor
 * Fetches all floors for a restaurant.
 */
...
/**
 * POST /tablebooking/fetch_all_table_by_floor
 * Fetches all tables for a given floor.
 */
...
/**
 * POST /tablebooking/fetch_all_table
