 ...
 *
 * Displays a list of food categories and allows selection to view food items.
 * Fetches categories from backend and shows category icons and names.
 * Integrates with FoodComponent to display food items for selected category.
 */
