 ...
 * TableCart.js
 *
 * Displays the cart for a specific table, calculates totals, and handles payment.
 * Integrates with Redux for order data and uses Razorpay for payment processing.
 * Allows admin to view, update, and checkout food orders for a table.
 */
